# Ontology REST API (`quantum-ontology-rest`)

This server-only module exposes REST endpoints to explore and administer your
ontology (TBox) and instance relationships (ABox), with a JointJS-ready graph
format for browser visualization. It is included by the standalone
`quantum-ontology-service`; ordinary applications should consume that service
through the generated SDK rather than depend on this module.
