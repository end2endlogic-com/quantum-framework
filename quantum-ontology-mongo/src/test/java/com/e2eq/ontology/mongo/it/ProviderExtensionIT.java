...
public class ProviderExtensionIT {
    ...
    public void writeHook_mergesAnnotationAndProviderEdges() {
        // Given two targets
        ItProvTarget t1 = new ItProvTarget(); t1.setRefName("TGT-1"); datastore.save(t1);
        ItProvTarget t2 = new ItProvTarget(); t2.setRefName("TGT-2"); datastore.save(t2);
        ...
        var edges = edgeRepo.findBySrc(TENANT, "SRC-1");
