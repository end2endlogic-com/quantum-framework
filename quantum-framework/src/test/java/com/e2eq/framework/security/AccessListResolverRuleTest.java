...
import com.e2eq.framework.tests.securityrules.TestCustomerAccessResolver;
...
/**
 * Integration test illustrating that an AccessListResolver can be used in a rule's IN clause
 * and that RuleContext incorporates the resolver-provided collection into the generated Morphia filter.
 */
@QuarkusTest
public class AccessListResolverRuleTest extends BaseRepoTest {
    ...
    public void testResolverBackedInFilter() {
