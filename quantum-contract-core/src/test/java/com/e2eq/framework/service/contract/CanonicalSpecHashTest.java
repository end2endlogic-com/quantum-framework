 ...
 * the SDK generator's Python canonicalization
 * ({@code json.dumps(spec, sort_keys=True, separators=(",", ":"), ensure_ascii=True)}
 * + SHA-256). If this test fails after a change in either implementation,
...
class CanonicalSpecHashTest {
    ...
    // Computed by the Python SDK generator's canonical hash function (2026-07-20).
