...
public class CognitoTokenValidator {
    ...
    public JsonWebToken validateToken(String token) throws Exception {
            ...
            if (publicKey == null) {
                throw new ParseException("Unable to find public key for kid: " + kid);
            }
    ...
    private PublicKey getPublicKey(String kid) throws Exception {
        ...
        if (publicKey != null) {
            ...
            try (JsonReader jsonReader = Json.createReader(new StringReader(jwksJson))) {
                ...
                for (int i = 0; i < keys.size(); i++) {
                    ...
                    if (kid.equals(key.getString("kid"))) {
                        ...
                        PublicJsonWebKey jwk = PublicJsonWebKey.Factory.newPublicJwk(key.toString());
    ...
    private String extractKidFromToken(String token) throws ParseException {
        try {
            ...
            try (JsonReader jsonReader = Json.createReader(new StringReader(headerJson))) {
