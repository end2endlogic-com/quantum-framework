...
public class DomainContext {
    @NotNull( message =  "tenantId must be non null") @NonNull protected String tenantId;
    ...
    public DataDomain toDataDomain(String ownerId) {
        return DataDomain.builder().tenantId(tenantId).orgRefName(orgRefName).accountNum(accountId).ownerId(ownerId).build();
    }
}
