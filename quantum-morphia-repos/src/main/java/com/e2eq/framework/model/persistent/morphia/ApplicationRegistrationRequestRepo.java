      ...
      if (orequest.isPresent()) {
         ...
         try (MorphiaSession session = this.startSession(tenantId)) {
            ...
            if (org.isEmpty()) {
               ...
               dataDomain.setDataSegment(envConfigUtils.getDefaultDataSegment());
               dataDomain.setOwnerId(envConfigUtils.getSystemUserId());
            ...
            if (ouserProfile.isEmpty()) {
               ...
               cred.setDomainContext(new DomainContext(dataDomain, envConfigUtils.getSystemRealm() ));
               ...
               overrides.put("accountManagement", envConfigUtils.getSystemRealm());
               overrides.put("security", envConfigUtils.getSystemRealm());
