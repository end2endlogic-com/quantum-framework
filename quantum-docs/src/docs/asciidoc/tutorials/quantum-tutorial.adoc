...
// Additional deep dive: Permission Resource APIs and client usage
See also: xref:../user-guide/permission-resource.adoc[Permission Resource: Check APIs and Client Usage].
